...
const FloatingInput = forwardRef(({ className, ...props }, ref) => {
  return (
    <Input
      placeholder=" "
...
const FloatingLabel = forwardRef(({ className, ...props }, ref) => {
  return (
    <Label
      className={cn(
...
const FloatingLabelInput = forwardRef(({ id, label, ...props }, ref) => {
  return (
