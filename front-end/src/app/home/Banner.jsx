          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Immerse yourself in the artistry of coffee as our skilled
                  baristas meticulously craft each cup with passion and
                  precision, ensuring a symphony of flavor in every sip
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">
                      Explore the fusion of coffee and tea, a harmonious blend
                      of boldness and tranquility, crafted to elevate your
                      beverage experience.
                    </p>
                  </div>
                </div>
