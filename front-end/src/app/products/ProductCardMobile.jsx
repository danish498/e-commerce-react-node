...
const ProductBoxDesktop = (props) => {
  const exampleProps = {
    pickupDelivery: "Free Pickup Today",
    productName: "Example Product",
    sellerStore: "Example Store",
    productPrice: "$19.99",
    price: "$24.99",
  ...
  return (
    <div>
      <div class=" m-10 flex w-full max-w-xs flex-row overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
        <a
        ...
        >
          ...
          <div className="absolute top-0 right-0 m-2 ">{likeIcon}</div>
        </a>
        <div class="mt-4 px-5 pb-5">
          ...
          {!inCart && (
            <button
              ...
              class="flex items-center justify-center rounded-md bg-secondary px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="mr-2 h-6 w-6"
